    ...
    public static void main(String[] args) {
       ...
       /* //全局配置
        ...
        dsConfig.setDbType(DbType.MYSQL)//数据库类型
                .setUrl("jdbc:mysql://113.31.110.212:3306/db8?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8")  //url
...
//        pkConfig.setModuleName(scanner("模块名"));//模块名,可以不设置
        pkConfig.setParent("com.example.backend_422");//放在哪个包下
